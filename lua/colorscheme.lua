...
set_highlight({
    list = {
        ...
        { group = "DiagnosticFloatingError", foreground = white },
        { group = "DiagnosticFloatingWarn", foreground = white },
        { group = "DiagnosticFloatingInfo", foreground = white },
        { group = "DiagnosticFloatingHint", foreground = white },
        ...
        { group = "DiagnosticInlinePath", foreground = orange },
        { group = "DiagnosticInlineCode", foreground = purple },
